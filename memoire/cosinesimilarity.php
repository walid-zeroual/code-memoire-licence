...
function numberOfRatedItems($ratingMatrix)
{
...
{
	//cosineSimilarity is the angle between two vectors
...
//print_r($ratingMatrix);
//print_r(getVectorFromItems('Chapitre1Notionsdelogiquemathématiques.pdf',$ratingMatrix));

/*recommend($ratingMatrix,'lol');
print_r(modifiedRatingMatrix($ratingMatrix));
print_r(cosineSimilarity('Chapitre1Notionsdelogiquemathématiques.pdf','Chapitre1Notionsdelogiquemathématiques.pdf',$ratingMatrix));*/


//print_r(modifiedRatingMatrix($ratingMatrix,$allItems,$allUsers));